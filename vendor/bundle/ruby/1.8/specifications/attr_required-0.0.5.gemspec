...
Gem::Specification.new do |s|
  ...
  s.date = %q{2012-02-16 00:00:00.000000000Z}
  s.description = %q{attr_required and attr_optional}
  s.email = %q{nov@matake.jp}
  s.extra_rdoc_files = ["LICENSE", "README.rdoc"]
  s.files = [".gitignore", ".rspec", ".travis.yml", "Gemfile", "Gemfile.lock", "LICENSE", "README.rdoc", "Rakefile", "VERSION", "attr_required.gemspec", "lib/attr_optional.rb", "lib/attr_required.rb", "spec/attr_optional_spec.rb", "spec/attr_required_spec.rb", "spec/spec_helper.rb"]
